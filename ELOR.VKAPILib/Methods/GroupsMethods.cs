...
namespace ELOR.VKAPILib.Methods {
    public class GroupsMethods {
        ...
        internal GroupsMethods(VKAPI api) {
            API = api;
        }

        public async Task<VKList<Group>> GetAsync(int userId, List<string> fields = null, List<string> filter = null, int count = 60, int offset = 0) {
        ...
        public async Task<List<Group>> GetByIdAsync(List<int> groupIds, List<string> fields = null) {
            ...
            if (!fields.IsNullOrEmpty()) parameters.Add("fields", fields.Combine());
            return await API.CallMethodAsync<List<Group>>("groups.getById", parameters);
        }
        ...
        public async Task<Group> GetByIdAsync(int groupId, List<string> fields = null) {
            ...
            if (!fields.IsNullOrEmpty()) parameters.Add("fields", fields.Combine());
            return (await API.CallMethodAsync<List<Group>>("groups.getById", parameters)).First();
        }
    }
}
